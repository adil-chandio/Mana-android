...
function modelText(output) {
  ...
  if (!noTools(message.tool_calls) || message.function_call !== void 0) reject("MESSAGE_TOOLS");
...
<footer>Local candidate: Qwen3-30B-A3B-FP8 \xB7 validation diagnostic v1 \xB7 via Cloudflare Workers AI. Model weights: Apache-2.0. No live inference verified for this candidate.<br>Use the registered browser. Never paste private keys, passwords, OTPs or provider tokens here.</footer>
